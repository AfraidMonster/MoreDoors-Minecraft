...
public class moredoors implements ModInitializer {
	...
	public static final Block COAL_DOOR = new CustomDoorBlock(FabricBlockSettings.copy(Blocks.COAL_BLOCK), registerSound(Blocks.COAL_BLOCK, true));
	public static final Block COAL_TRAPDOOR = new CustomTrapdoorBlock(FabricBlockSettings.copy(Blocks.COAL_BLOCK), registerSound(Blocks.COAL_BLOCK, true));
	...
	public static final Block OBSIDIAN_DOOR = new CustomDoorBlock(FabricBlockSettings.copy(Blocks.OBSIDIAN),registerSound(Blocks.OBSIDIAN, true));
	public static final Block OBSIDIAN_TRAPDOOR = new CustomTrapdoorBlock(FabricBlockSettings.copy(Blocks.OBSIDIAN), registerSound(Blocks.OBSIDIAN, true));
	...
	public static final Block BEDROCK_DOOR = new CustomDoorBlock(FabricBlockSettings.copy(Blocks.BEDROCK), registerSound(Blocks.BEDROCK, true));
	public static final Block BEDROCK_TRAPDOOR = new CustomTrapdoorBlock(FabricBlockSettings.copy(Blocks.BEDROCK), registerSound(Blocks.BEDROCK, true));
