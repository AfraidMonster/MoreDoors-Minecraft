...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> GOLD_DOOR = registerBlock("gold_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK), registerSound(Blocks.GOLD_BLOCK, true)));
    ...
    public static final RegistryObject<Block> EMERALD_DOOR = registerBlock("emerald_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.EMERALD_BLOCK),  registerSound( Blocks.EMERALD_BLOCK, true)));

    public static final RegistryObject<Block> REDSTONE_DOOR = registerBlock("redstone_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.REDSTONE_BLOCK),   registerSound( Blocks.REDSTONE_BLOCK, true)));

    public static final RegistryObject<Block> COAL_DOOR = registerBlock("coal_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COAL_BLOCK),   registerSound( Blocks.COAL_BLOCK, true)));

    public static final RegistryObject<Block> STONE_DOOR = registerBlock("stone_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE),  registerSound( Blocks.STONE, false)));


    public static final RegistryObject<Block> GOLD_TRAPDOOR = registerBlock("gold_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GOLD_BLOCK),   registerSound( Blocks.GOLD_BLOCK, true)));

    public static final RegistryObject<Block> DIAMOND_TRAPDOOR = registerBlock("diamond_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DIAMOND_BLOCK),   registerSound( Blocks.DIAMOND_BLOCK, true)));
    ...
    public static final RegistryObject<Block> EMERALD_TRAPDOOR = registerBlock("emerald_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.EMERALD_BLOCK),  registerSound( Blocks.EMERALD_BLOCK, true)));

    public static final RegistryObject<Block> REDSTONE_TRAPDOOR = registerBlock("redstone_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.REDSTONE_BLOCK),  registerSound( Blocks.REDSTONE_BLOCK, true)));

    public static final RegistryObject<Block> COAL_TRAPDOOR = registerBlock("coal_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COAL_BLOCK),  registerSound( Blocks.COAL_BLOCK, true)));

    public static final RegistryObject<Block> STONE_TRAPDOOR = registerBlock("stone_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE),  registerSound( Blocks.STONE, false)));


    public static final RegistryObject<Block> COBBLESTONE_DOOR = registerBlock("cobblestone_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COBBLESTONE),  registerSound( Blocks.STONE, false)));

    public static final RegistryObject<Block> ANDESITE_DOOR = registerBlock("andesite_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_ANDESITE),  registerSound( Blocks.POLISHED_ANDESITE, false)));

    public static final RegistryObject<Block> DIORITE_DOOR = registerBlock("diorite_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_DIORITE),   registerSound( Blocks.POLISHED_DIORITE, false)));

    public static final RegistryObject<Block> GRANITE_DOOR = registerBlock("granite_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_GRANITE),  registerSound( Blocks.POLISHED_GRANITE, false)));

    public static final RegistryObject<Block> SANDSTONE_DOOR = registerBlock("sandstone_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SANDSTONE),  registerSound( Blocks.SANDSTONE, false)));

    public static final RegistryObject<Block> RED_SANDSTONE_DOOR = registerBlock("red_sandstone_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_SANDSTONE), registerSound( Blocks.RED_SANDSTONE, false)));

    public static final RegistryObject<Block> COBBLED_DEEPSLATE_DOOR = registerBlock("cobbled_deepslate_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COBBLED_DEEPSLATE),  registerSound( Blocks.COBBLED_DEEPSLATE, false)));

    public static final RegistryObject<Block> CALCITE_DOOR = registerBlock("calcite_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CALCITE),   registerSound( Blocks.CALCITE, false)));


    public static final RegistryObject<Block> POLISHED_DEEPSLATE_DOOR = registerBlock("polished_deepslate_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_DEEPSLATE),  registerSound( Blocks.POLISHED_DEEPSLATE, false)));


    public static final RegistryObject<Block> COBBLESTONE_TRAPDOOR = registerBlock("cobblestone_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COBBLESTONE),   registerSound( Blocks.COBBLESTONE, false)));


    public static final RegistryObject<Block> ANDESITE_TRAPDOOR = registerBlock("andesite_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_ANDESITE),   registerSound( Blocks.POLISHED_ANDESITE, false)));

    public static final RegistryObject<Block> DIORITE_TRAPDOOR = registerBlock("diorite_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_DIORITE), registerSound( Blocks.POLISHED_DIORITE, false)));

    public static final RegistryObject<Block> GRANITE_TRAPDOOR = registerBlock("granite_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_GRANITE),   registerSound( Blocks.POLISHED_GRANITE, false)));

    public static final RegistryObject<Block> SANDSTONE_TRAPDOOR = registerBlock("sandstone_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SANDSTONE),   registerSound( Blocks.SANDSTONE, false)));

    public static final RegistryObject<Block> RED_SANDSTONE_TRAPDOOR = registerBlock("red_sandstone_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_SANDSTONE),   registerSound( Blocks.RED_SANDSTONE, false)));

    public static final RegistryObject<Block> COBBLED_DEEPSLATE_TRAPDOOR = registerBlock("cobbled_deepslate_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COBBLED_DEEPSLATE),  registerSound( Blocks.COBBLED_DEEPSLATE, false)));

    public static final RegistryObject<Block> CALCITE_TRAPDOOR = registerBlock("calcite_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CALCITE),  registerSound( Blocks.CALCITE, false)));

    public static final RegistryObject<Block> POLISHED_DEEPSLATE_TRAPDOOR = registerBlock("polished_deepslate_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_DEEPSLATE),  registerSound( Blocks.POLISHED_DEEPSLATE, false)));


    public static final RegistryObject<Block> BASALT_DOOR = registerBlock("basalt_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BASALT),   registerSound( Blocks.BASALT, false)));

    public static final RegistryObject<Block> BLACKSTONE_DOOR = registerBlock("blackstone_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_BLACKSTONE_BRICKS),   registerSound( Blocks.BLACKSTONE, false)));

    public static final RegistryObject<Block> NETHERRACK_DOOR = registerBlock("netherrack_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.NETHERRACK),   registerSound( Blocks.NETHERRACK, false)));

    public static final RegistryObject<Block> END_STONE_DOOR = registerBlock("end_stone_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.END_STONE),   registerSound( Blocks.END_STONE, false)));

    public static final RegistryObject<Block> PURPUR_DOOR = registerBlock("purpur_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.PURPUR_BLOCK),   registerSound( Blocks.PURPUR_BLOCK, false)));

    public static final RegistryObject<Block> QUARTZ_DOOR = registerBlock("quartz_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_BLOCK),  registerSound( Blocks.QUARTZ_BLOCK, false)));

    public static final RegistryObject<Block> NETHER_BRICK_DOOR = registerBlock("nether_brick_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.NETHER_BRICKS),  registerSound( Blocks.NETHER_BRICKS, false)));

    public static final RegistryObject<Block> PRISMARINE_DOOR = registerBlock("prismarine_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.PRISMARINE_BRICKS),  registerSound( Blocks.PRISMARINE_BRICKS, false)));

    public static final RegistryObject<Block> BOOKSHELF_DOOR = registerBlock("bookshelf_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BOOKSHELF),  registerSound( Blocks.BOOKSHELF, false)));


    public static final RegistryObject<Block> BASALT_TRAPDOOR = registerBlock("basalt_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BASALT),   registerSound( Blocks.BASALT, false)));

    public static final RegistryObject<Block> BLACKSTONE_TRAPDOOR = registerBlock("blackstone_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.POLISHED_BLACKSTONE_BRICKS),  registerSound( Blocks.BLACKSTONE, false)));

    public static final RegistryObject<Block> NETHERRACK_TRAPDOOR = registerBlock("netherrack_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.NETHERRACK), registerSound( Blocks.NETHERRACK, false)));

    public static final RegistryObject<Block> END_STONE_TRAPDOOR = registerBlock("end_stone_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.END_STONE),   registerSound( Blocks.END_STONE, false)));

    public static final RegistryObject<Block> PURPUR_TRAPDOOR = registerBlock("purpur_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.PURPUR_BLOCK),  registerSound( Blocks.PURPUR_BLOCK, false)));

    public static final RegistryObject<Block> QUARTZ_TRAPDOOR = registerBlock("quartz_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.QUARTZ_BLOCK),  registerSound( Blocks.QUARTZ_BLOCK, false)));

    public static final RegistryObject<Block> NETHER_BRICK_TRAPDOOR = registerBlock("nether_brick_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.NETHER_BRICKS),  registerSound( Blocks.NETHER_BRICKS, false)));

    public static final RegistryObject<Block> PRISMARINE_TRAPDOOR = registerBlock("prismarine_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.PRISMARINE_BRICKS),  registerSound( Blocks.PRISMARINE_BRICKS, false)));

    public static final RegistryObject<Block> BOOKSHELF_TRAPDOOR = registerBlock("bookshelf_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BOOKSHELF),   registerSound( Blocks.BOOKSHELF, false)));


    public static final RegistryObject<Block> AMETHYST_DOOR = registerBlock("amethyst_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.AMETHYST_BLOCK),  registerSound( Blocks.AMETHYST_BLOCK, false)));

    public static final RegistryObject<Block> SMOOTH_STONE_DOOR = registerBlock("smooth_stone_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SMOOTH_STONE),  registerSound( Blocks.SMOOTH_STONE, false)));
    ...
    public static final RegistryObject<Block> GLASS_DOOR = registerBlock("glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GLASS),  registerSound( Blocks.GLASS, false)));

    public static final RegistryObject<Block> BEDROCK_DOOR = registerBlock("bedrock_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BEDROCK),  registerSound( Blocks.BEDROCK, true)));

    public static final RegistryObject<Block> SPONGE_DOOR = registerBlock("sponge_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SPONGE),  registerSound( Blocks.SPONGE, false)));

    public static final RegistryObject<Block> DRIPSTONE_DOOR = registerBlock("dripstone_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DRIPSTONE_BLOCK),   registerSound( Blocks.DRIPSTONE_BLOCK, false)));


    public static final RegistryObject<Block> AMETHYST_TRAPDOOR = registerBlock("amethyst_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.AMETHYST_BLOCK),  registerSound( Blocks.AMETHYST_BLOCK, false)));

    public static final RegistryObject<Block> SMOOTH_STONE_TRAPDOOR = registerBlock("smooth_stone_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SMOOTH_STONE),  registerSound( Blocks.SMOOTH_STONE, false)));

    public static final RegistryObject<Block> OBSIDIAN_TRAPDOOR = registerBlock("obsidian_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OBSIDIAN),  registerSound( Blocks.OBSIDIAN, true)));

    public static final RegistryObject<Block> BRICK_TRAPDOOR = registerBlock("brick_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BRICKS),  registerSound( Blocks.BRICKS, false)));

    public static final RegistryObject<Block> ICE_TRAPDOOR = registerBlock("ice_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.ICE),  registerSound( Blocks.ICE, false)));

    public static final RegistryObject<Block> GLASS_TRAPDOOR = registerBlock("glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GLASS),  registerSound( Blocks.GLASS, false)));

    public static final RegistryObject<Block> BEDROCK_TRAPDOOR = registerBlock("bedrock_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BEDROCK),  registerSound( Blocks.BEDROCK, true)));

    public static final RegistryObject<Block> SPONGE_TRAPDOOR = registerBlock("sponge_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SPONGE),  registerSound( Blocks.SPONGE, false)));

    public static final RegistryObject<Block> DRIPSTONE_TRAPDOOR = registerBlock("dripstone_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DRIPSTONE_BLOCK),  registerSound( Blocks.DRIPSTONE_BLOCK, false)));


    public static final RegistryObject<Block> MUD_BRICK_DOOR = registerBlock("mud_brick_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.MUD_BRICKS),  registerSound( Blocks.MUD_BRICKS, false)));



    public static final RegistryObject<Block> SCULK_DOOR = registerBlock("sculk_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SCULK),  registerSound( Blocks.SCULK, false)));

    public static final RegistryObject<Block> BLACK_STAINED_GLASS_DOOR = registerBlock("black_stained_glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_STAINED_GLASS),  registerSound( Blocks.BLACK_STAINED_GLASS, false)));

    public static final RegistryObject<Block> BLUE_STAINED_GLASS_DOOR = registerBlock("blue_stained_glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BLUE_STAINED_GLASS),  registerSound( Blocks.BLUE_STAINED_GLASS, false)));

    public static final RegistryObject<Block> BROWN_STAINED_GLASS_DOOR = registerBlock("brown_stained_glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BROWN_STAINED_GLASS),  registerSound( Blocks.BROWN_STAINED_GLASS, false)));

    public static final RegistryObject<Block> CYAN_STAINED_GLASS_DOOR = registerBlock("cyan_stained_glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CYAN_STAINED_GLASS),  registerSound( Blocks.CYAN_STAINED_GLASS, false)));

    public static final RegistryObject<Block> GRAY_STAINED_GLASS_DOOR = registerBlock("gray_stained_glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GRAY_STAINED_GLASS),  registerSound( Blocks.GRAY_STAINED_GLASS, false)));

    public static final RegistryObject<Block> GREEN_STAINED_GLASS_DOOR = registerBlock("green_stained_glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GREEN_STAINED_GLASS),  registerSound( Blocks.GREEN_STAINED_GLASS, false)));


    public static final RegistryObject<Block> LIGHT_BLUE_STAINED_GLASS_DOOR = registerBlock("light_blue_stained_glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_BLUE_STAINED_GLASS),  registerSound( Blocks.LIGHT_BLUE_STAINED_GLASS, false)));
    ...
    public static final RegistryObject<Block> MUD_BRICK_TRAPDOOR = registerBlock("mud_brick_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.MUD_BRICKS),  registerSound( Blocks.MUD_BRICKS, false)));

    public static final RegistryObject<Block> SCULK_TRAPDOOR = registerBlock("sculk_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SCULK),  registerSound( Blocks.SCULK, false)));

    public static final RegistryObject<Block> BLACK_STAINED_GLASS_TRAPDOOR = registerBlock("black_stained_glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BLACK_STAINED_GLASS),  registerSound( Blocks.BLACK_STAINED_GLASS, false)));

    public static final RegistryObject<Block> BLUE_STAINED_GLASS_TRAPDOOR = registerBlock("blue_stained_glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BLUE_STAINED_GLASS),  registerSound( Blocks.BLUE_STAINED_GLASS, false)));

    public static final RegistryObject<Block> BROWN_STAINED_GLASS_TRAPDOOR = registerBlock("brown_stained_glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BROWN_STAINED_GLASS),  registerSound( Blocks.BROWN_STAINED_GLASS, false)));

    public static final RegistryObject<Block> CYAN_STAINED_GLASS_TRAPDOOR = registerBlock("cyan_stained_glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CYAN_STAINED_GLASS),  registerSound( Blocks.CYAN_STAINED_GLASS, false)));

    public static final RegistryObject<Block> GRAY_STAINED_GLASS_TRAPDOOR = registerBlock("gray_stained_glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GRAY_STAINED_GLASS),  registerSound( Blocks.GRAY_STAINED_GLASS, false)));

    public static final RegistryObject<Block> GREEN_STAINED_GLASS_TRAPDOOR = registerBlock("green_stained_glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.GREEN_STAINED_GLASS),   registerSound( Blocks.GREEN_STAINED_GLASS, false)));
    ...
    public static final RegistryObject<Block> LIGHT_BLUE_STAINED_GLASS_TRAPDOOR = registerBlock("light_blue_stained_glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_BLUE_STAINED_GLASS),  registerSound( Blocks.LIGHT_BLUE_STAINED_GLASS, false)));



    public static final RegistryObject<Block> LIGHT_GRAY_STAINED_GLASS_DOOR = registerBlock("light_gray_stained_glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_GRAY_STAINED_GLASS),  registerSound( Blocks.LIGHT_GRAY_STAINED_GLASS, false)));

    public static final RegistryObject<Block> LIME_STAINED_GLASS_DOOR = registerBlock("lime_stained_glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LIME_STAINED_GLASS),   registerSound( Blocks.LIME_STAINED_GLASS, false)));

    public static final RegistryObject<Block> MAGENTA_STAINED_GLASS_DOOR = registerBlock("magenta_stained_glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.MAGENTA_STAINED_GLASS),  registerSound( Blocks.MAGENTA_STAINED_GLASS, false)));

    public static final RegistryObject<Block> ORANGE_STAINED_GLASS_DOOR = registerBlock("orange_stained_glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.ORANGE_STAINED_GLASS),  registerSound( Blocks.ORANGE_STAINED_GLASS, false)));

    public static final RegistryObject<Block> PINK_STAINED_GLASS_DOOR = registerBlock("pink_stained_glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.PINK_STAINED_GLASS),  registerSound( Blocks.PINK_STAINED_GLASS, false)));

    public static final RegistryObject<Block> PURPLE_STAINED_GLASS_DOOR = registerBlock("purple_stained_glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.PURPLE_STAINED_GLASS),  registerSound( Blocks.PURPLE_STAINED_GLASS, false)));

    public static final RegistryObject<Block> RED_STAINED_GLASS_DOOR = registerBlock("red_stained_glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_STAINED_GLASS),  registerSound( Blocks.RED_STAINED_GLASS, false)));

    public static final RegistryObject<Block> WHITE_STAINED_GLASS_DOOR = registerBlock("white_stained_glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_STAINED_GLASS), registerSound( Blocks.WHITE_STAINED_GLASS, false)));

    public static final RegistryObject<Block> YELLOW_STAINED_GLASS_DOOR = registerBlock("yellow_stained_glass_door", () ->
            new CustomDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.YELLOW_STAINED_GLASS),  registerSound( Blocks.YELLOW_STAINED_GLASS, false)));
    ...
    public static final RegistryObject<Block> LIGHT_GRAY_STAINED_GLASS_TRAPDOOR = registerBlock("light_gray_stained_glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LIGHT_GRAY_STAINED_GLASS),  registerSound( Blocks.LIGHT_GRAY_STAINED_GLASS, false)));

    public static final RegistryObject<Block> LIME_STAINED_GLASS_TRAPDOOR = registerBlock("lime_stained_glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.LIME_STAINED_GLASS),  registerSound( Blocks.LIME_STAINED_GLASS, false)));

    public static final RegistryObject<Block> MAGENTA_STAINED_GLASS_TRAPDOOR = registerBlock("magenta_stained_glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.MAGENTA_STAINED_GLASS),  registerSound( Blocks.MAGENTA_STAINED_GLASS, false)));

    public static final RegistryObject<Block> ORANGE_STAINED_GLASS_TRAPDOOR = registerBlock("orange_stained_glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.ORANGE_STAINED_GLASS),  registerSound( Blocks.ORANGE_STAINED_GLASS, false)));

    public static final RegistryObject<Block> PINK_STAINED_GLASS_TRAPDOOR = registerBlock("pink_stained_glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.PINK_STAINED_GLASS),  registerSound( Blocks.PINK_STAINED_GLASS, false)));

    public static final RegistryObject<Block> PURPLE_STAINED_GLASS_TRAPDOOR = registerBlock("purple_stained_glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.PURPLE_STAINED_GLASS),   registerSound( Blocks.PURPLE_STAINED_GLASS, false)));

    public static final RegistryObject<Block> RED_STAINED_GLASS_TRAPDOOR = registerBlock("red_stained_glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_STAINED_GLASS),   registerSound( Blocks.RED_STAINED_GLASS, false)));

    public static final RegistryObject<Block> WHITE_STAINED_GLASS_TRAPDOOR = registerBlock("white_stained_glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHITE_STAINED_GLASS),  registerSound( Blocks.WHITE_STAINED_GLASS, false)));

    public static final RegistryObject<Block> YELLOW_STAINED_GLASS_TRAPDOOR = registerBlock("yellow_stained_glass_trapdoor", () ->
            new CustomTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.YELLOW_STAINED_GLASS),   registerSound( Blocks.YELLOW_STAINED_GLASS, false)));
    ...
    public static final RegistryObject<Block> TINTED_GLASS_DOOR = registerBlock("tinted_glass_door", () ->
            new CustomTintedDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS),  registerSound( Blocks.TINTED_GLASS, false)));

    public static final RegistryObject<Block> TINTED_GLASS_TRAPDOOR = registerBlock("tinted_glass_trapdoor", () ->
            new CustomTintedTrapDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS),  registerSound( Blocks.TINTED_GLASS, false)));
